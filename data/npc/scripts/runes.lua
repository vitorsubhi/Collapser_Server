...
shopModule:addBuyableItem({'health potion'}, 7618, 20, 1, 'health potion')
shopModule:addBuyableItem({'mana potion'}, 7620, 20, 1, 'mana potion')
shopModule:addBuyableItem({'strong mana'}, 7589, 20, 1, 'strong mana potion')
